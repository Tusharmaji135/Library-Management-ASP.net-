                ...
                <div class="card p-4">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <img src="images/publisher.png" width="90" alt="Books" />
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
                                ...
                                <asp:TextBox ID="TextBox6" CssClass="form-control" placeholder="Publisher name" runat="server"></asp:TextBox>
                            </div>
                        </div>
...
<div class="col-md-7">
    <div class="card p-4">
        <div class="card-body">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bookStoreDBConnectionString %>" ProviderName="<%$ ConnectionStrings:bookStoreDBConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [publisher_master_tbl]"></asp:SqlDataSource>
