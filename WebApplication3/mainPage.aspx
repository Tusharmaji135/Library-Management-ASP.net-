        ...
        <div class="hero-section">
            <div class="container">
                <div class="hero-content text-center">
                    <h1 class="hero-title display-3">Welcome to College Management System</h1>
                    <p class="hero-subtitle">Streamline your educational institution with our comprehensive management platform</p>
            ...
            <div class="container">
                <div class="row text-center mb-5">
                    <div class="col-12">
                        ...
                        <p class="text-white-50 fs-5">Everything you need to manage your college efficiently</p>
                    </div>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card fade-in">
                            ...
                            <p class="feature-desc">Comprehensive student records, enrollment tracking, and academic progress monitoring.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card fade-in">
                            ...
                            <p class="feature-desc">Manage faculty information, schedules, and performance tracking in one place.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card fade-in">
                            ...
                            <p class="feature-desc">Organize courses, curricula, and academic programs with detailed course information.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card fade-in">
                            ...
                            <p class="feature-desc">Digital library management with book tracking, reservations, and inventory control.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="text-white text-center">
        <div class="container">
            <div class="footer-content">
                <p class="mb-2">&copy; 2025 College Management System | All Rights Reserved</p>
                <p class="mb-0">
